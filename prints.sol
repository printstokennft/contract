...
/**
 ...
 Prints Token is the most innovative utility smart contract on BSC
 Prints is empowering the future of 3D Printing via the world's first NFT marketplace for 3D printing blueprints
 Hop on board this absolute rocket of innovation
 
 TOKENOMICS:
 5% fee on every transaction (buy, sale, transfer) is redistributed to wallet holders
 5% fee on every transaction is added to the liquidity pool to raise the price floor and increase stability
...
contract Prints is Context, IERC20, Ownable {
    ...
    string private _name = "Prints";
    string private _symbol = "PRINTS";
    ...
    uint256 constant numTokensSellToAddToLiquidity = 2000000  * 10**9;
